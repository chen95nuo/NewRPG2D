...
[AddComponentMenu("NGUI/Interaction/Button Message3(can transfer string param)")]
public class UIButtonMessage3 : MonoBehaviour
{
	public enum Trigger
	{
		OnClick,
	...
	public bool transferStringParam=true;
...
//			target.SendMessage(functionName, gameObject, SendMessageOptions.DontRequireReceiver);
			if(transferStringParam)
			{
				target.SendMessage(functionName, stringParam, SendMessageOptions.DontRequireReceiver);
			}
			else
			{
