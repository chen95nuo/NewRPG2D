...
public class UIToggle2 : UIWidgetContainer
{
	/// <summary>
	/// List of all the active toggles currently in the scene.
	/// </summary>

	static public BetterList<UIToggle2> list = new BetterList<UIToggle2>();

	/// <summary>
	/// Current toggle that sent a state change notification.
	/// </summary>

	static public UIToggle2 current;
	...
	public bool value
	{
		...
		set { if (group == 0 || value || value != mIsActive || optionCanBeNone || !mStarted) Set(value); }
	}
