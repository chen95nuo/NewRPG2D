...
public class LoadingControl : MonoBehaviour ,ProcessResponse{
	...
	//==内网公告服==//
	private string InnerServerIp="150.109.72.39";
	private string InnerServerPort="8080";
	//==外网测试公告服==//
	private string OuterServerIp="150.109.72.39";
	...
	private const string VersionUrl="http://150.109.72.39:8080/card_server_center/gift.htm?action=serverVersion";
