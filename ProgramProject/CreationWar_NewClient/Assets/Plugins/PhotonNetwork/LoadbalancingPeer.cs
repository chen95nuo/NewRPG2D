...
#region //john.add 2014.4.3	
	private static InRoom m_LogicObj=null;
	
	public static void SetLogicObj(InRoom _LogicObj)
	{
		m_LogicObj=_LogicObj;
	}
#endregion
    ...
    public virtual bool OpJoinLobby()
    {
		...
		{
			PhotonHandler.ShowLog("OpJoinLobby()");
		}
