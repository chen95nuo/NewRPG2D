...
#region john.writedelay
	private int m_dwLastWriteTime=0;
	public bool IsWriteViewData()
	{
		if(System.Environment.TickCount>m_dwLastWriteTime)
		{
			m_dwLastWriteTime=System.Environment.TickCount+PhotonHandler.johnSendTimes;
			return true;
		}
		else
		{
...
//                Debug.LogError("The observed monobehaviour (" + this.observed.name + ") of this PhotonView does not implement OnPhotonSerialize()!");
    ...
    {
		RPC(methodName,PhotonTargets.All,parameters);
    }
