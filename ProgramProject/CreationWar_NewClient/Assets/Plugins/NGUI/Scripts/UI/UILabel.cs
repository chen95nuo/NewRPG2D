...
{
	[HideInInspector]
	public LableLink lableLink;
	[HideInInspector]
	public UISprite exps;
	[HideInInspector]
	public bool expsEnable=false;
	...
	void OnEnable()
	{
		if(exps!=null)
		{
			if(expsEnable)
			{
				exps.gameObject.active=true;
			}
			else
			{
				exps.gameObject.active=false;
			}
		}
	}
	...
	public void SetCurrentSelection ()
	{
		if (UIPopupList.current != null)
		{
			text = UIPopupList.current.isLocalized ?
				StaticLoc.Loc.Get(UIPopupList.current.value) :
