...
//	
	...
	/// </summary>
	public static Localization StaticLoc;
...
//				PlayerPrefs.DeleteKey("Language");
	...
	void Update(){
//		if(currentLanguage != YuanUnityPhoton.LanguageStr && YuanUnityPhoton.LanguageStr != ""){
//			currentLanguage = YuanUnityPhoton.LanguageStr;
//		}
	}
...
//			Destroy(gameObject); 
	...
	void Start () {
			//FixBrokenWord();
//		if(currentLanguage != "CR"){
//			currentLanguage = "CR";
//		}
		if (!string.IsNullOrEmpty(startingLanguage)) currentLanguage = startingLanguage; 
		//InvokeRepeating("FixBrokenWord",0,3);
	}
	...
	{
		string val;
//		Debug.Log(mDictionary.TryGetValue(key, out val) + " == bool " + val + " == " + key);
