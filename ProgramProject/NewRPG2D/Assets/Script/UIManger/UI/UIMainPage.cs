...
public class UIMainPage : TTUIPage
{
    ...
    public override void Awake(GameObject go)
    {
        ...
        this.gameObject.transform.Find("DownBackGround/btn_CardHouse").GetComponent<Button>().onClick.AddListener(ShowCardHouse);
    ...
    private void ShowCardHouse()
    {
        ShowPage<UICardHousePage>();
        UpdateCardData data = new UpdateCardData(null, GridType.Nothing);
