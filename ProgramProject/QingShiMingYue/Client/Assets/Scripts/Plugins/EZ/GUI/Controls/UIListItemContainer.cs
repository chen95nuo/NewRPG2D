...
//				continue;
	...
	virtual public Vector2 TopLeftEdge
	{
		get { return topLeftEdge; }
	}

	virtual public Vector2 BottomRightEdge
	{
	...
	{
		// Disable this method, To make the hide operation of control in UIListItemContainer works, DO NOT SUPPORT SPRITE MANAGER [12/17/2011 sonilics]
//		for (int i = 0; i < uiObjs.Count; ++i)
//			uiObjs[i].Hide(tf);
//
//		for (int i = 0; i < textObjs.Count; ++i)
