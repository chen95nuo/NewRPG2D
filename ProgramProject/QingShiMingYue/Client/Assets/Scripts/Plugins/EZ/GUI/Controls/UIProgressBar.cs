	...
	public override void Start()
	{
		...
		if (Application.isPlaying)
		{
			...
			if (!disableEmptyBar)
			{
				...
				// Make emptySprite same setting with border [sonilics]
				emptySprite.Start();
				emptySprite.xMirror = xMirror;
				emptySprite.yMirror = yMirror;
				emptySprite.xTextureTile = xTextureTile;
				emptySprite.yTextureTile = yTextureTile;
				emptySprite.leftBorder = leftBorder;
				emptySprite.rightBorder = rightBorder;
				emptySprite.topBorder = topBorder;
				emptySprite.bottomBorder = bottomBorder;
				emptySprite.spriteMesh.Init();
