...
namespace KodGames.Graphics
{
	...
	/// This a class to manipulate an object's position with spherical coordinates instead of cartesian coordinates (Vector3). 
	/// This is heavily based upon this implementation : http://blog.nobel-joergensen.com/2010/10/22/spherical-coordinates-in-unity/. 
	/// Here is the description given there : Spherical coordinate system is an alternative coordinate system, where two orthogonale coordinate axis define the world space in 3D.
	/// 
	...
	public class SphericalCoordinates
	{
		...
		public SphericalCoordinates(float r, float p, float s, float minRadius, float maxRadius, float minPolar, float maxPolar, float minElevation, float maxElevation)
		{
		...
		public SphericalCoordinates(float r, float p, float s)
			: this(r, p, s, 1f, 20f, 0f, (Mathf.PI * 2f), 0f, (Mathf.PI / 3f))
		{

		}

		public SphericalCoordinates(Vector3 cartesianCoordinate, float minRadius, float maxRadius, float minPolar, float maxPolar, float minElevation, float maxElevation)
		{
			_minRadius = minRadius;
			_maxRadius = maxRadius;
			_minPolar = minPolar;
		...
		public SphericalCoordinates(Vector3 cartesianCoordinate)
			: this(cartesianCoordinate, 1f, 20f, 0f, (Mathf.PI * 2f), 0f, (Mathf.PI / 3f))
		{
		...
		public SphericalCoordinates(Transform T, float minRadius, float maxRadius, float minPolar, float maxPolar, float minElevation, float maxElevation)
