...
//				CrittercismPlugin.LeaveBreadcrumb("BreadCrumb");

				Debug.Log("UserTest");
//				CrittercismPlugin.SetUsername("Username");
				
				Debug.Log("ValueTest");
//				CrittercismPlugin.SetValue("A Value", "A Key");
				
				Debug.Log("EventTest");
	//			CrittercismPlugin.LogEvent("EventTest", null);
			}
		}
